...
from event.views import OrganizerDashboardView, update_task, delete_task, rsvp_event, participant_dashboard, admin_dashboard, assign_role, create_group, group_list
from event.views import all_events, remove_participant_from_event, remove_group, role_based_dashboard, EventDetailView, CreateEventView, AddCategoryView
